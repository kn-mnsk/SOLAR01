...
// Modified: Jan 2023 (Actualyy same as original)
///////////////////////////////////////////////////////////////////////////////
...
// essential to trackbar control property, when setting "Transparent Background" to true;
...
namespace Win
{
	...
	public:
		// ctor / dtor
		baseWinForm() : handle{ 0 }, parent{ 0 }, id{ 0 }, fontHandle{ 0 } {}
		baseWinForm(HWND parent, int id, bool visible = true) : handle(GetDlgItem(parent, id)), parent{ 0 }, id{ 0 }, fontHandle{ 0 } { if (!visible) disable(); }
		~baseWinForm() {
	...
	// button class
	///////////////////////////////////////////////////////////////////////////
	class Button : public baseWinForm
	{
	public:
		// ctor / dtor
		Button() : baseWinForm() {}
		Button(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~Button() {}
	...
	// Text box class
	///////////////////////////////////////////////////////////////////////////
	class TextBox : public baseWinForm
	{
	public:
		TextBox() : baseWinForm() {}
		TextBox(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~TextBox() {}
	...
	public:
		...
		// set all members
		void set(HWND parent, int id, bool visible = true) {
			baseWinForm::set(parent, id, visible);
	...
	// List box class
	///////////////////////////////////////////////////////////////////////////
	class ListBox : public baseWinForm
	{
	public:
		ListBox() : baseWinForm(), listCount(0) {}
		ListBox(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible), listCount(0) {}
		~ListBox() {}
	...
	///////////////////////////////////////////////////////////////////////////
	class Trackbar : public baseWinForm
	{
	public:
		Trackbar() : baseWinForm() {}
		Trackbar(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~Trackbar() {}
	...
	// Combo box class
	///////////////////////////////////////////////////////////////////////////
	class ComboBox : public baseWinForm
	{
	public:
		ComboBox() : baseWinForm() {}
		ComboBox(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~ComboBox() {}
		...
		void getText(int index, wchar_t* buf) {
	...
	///////////////////////////////////////////////////////////////////////////
	class TreeView : public baseWinForm
	{
	public:
		TreeView() : baseWinForm() {}
		TreeView(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~TreeView() {}
	...
	// change.
	///////////////////////////////////////////////////////////////////////////
	class UpDownBox : public baseWinForm
	{
	public:
		UpDownBox() : baseWinForm() {}
		UpDownBox(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~UpDownBox() {}
	...
	///////////////////////////////////////////////////////////////////////////
	class Picture : public baseWinForm
	{
	public:
		// ctor / dtor
		Picture() : baseWinForm(), bitmap{} {}
		Picture(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible), bitmap{} {}
		~Picture() {}
	...
	// It requires comctl32.dll.
	///////////////////////////////////////////////////////////////////////////
	class Tab : public baseWinForm
	{
	public:
		Tab() : baseWinForm() {}
		Tab(HWND parent, int id, bool visible = true) : baseWinForm(parent, id, visible) {}
		~Tab() {}
